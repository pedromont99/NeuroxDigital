      ...
      <div className="max-w-3xl mx-auto px-6 pt-40 pb-24 text-white/80">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed">
            A Clean4You é operada por Cláudio Rodrigues, em regime de trabalhador independente, NIF 222694416. Para qualquer questão relacionada com esta política ou com os seus dados pessoais, pode contactar-nos através de{" "}
