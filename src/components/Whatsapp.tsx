...
export default function Whatsapp() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-dark text-[#F2EDE4] px-4 py-2 rounded-xl text-sm font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-slate-100">
        Fale connosco agora!
      </span>

      {/* Ícone com bounce vertical */}
      <motion.svg
        className="w-8 h-8"
        fill="currentColor"
        viewBox="0 0 24 24"
